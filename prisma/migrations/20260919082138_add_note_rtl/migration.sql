...
INSERT INTO "new_notes" ("authorId", "body", "campaignId", "createdAt", "folderId", "id", "tags", "title", "updatedAt", "visibility") SELECT "authorId", "body", "campaignId", "createdAt", "folderId", "id", "tags", "title", "updatedAt", "visibility" FROM "notes";
DROP TABLE "notes";
